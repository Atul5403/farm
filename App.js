    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.playArea}>
          {Array.apply(null, Array(10)).map((el, rowIdx) => {
            return (
              <View style={styles.playRow} key={rowIdx}>
                {Array.apply(null, Array(10)).map((el, colIdx) => {
                  let moleIdx = rowIdx * 10 + colIdx
...
const styles = StyleSheet.create({
  ...
  playArea: {
    ...
    marginTop: Constants.YR * 200,
    height: Constants.MAX_HEIGHT - Constants.YR * 299 - Constants.YR * 112,
    flexDirection: 'column',
    borderWidth: 5,
    borderColor: 'black',
    marginHorizontal: 10,
  ...
  playRow: {
    height:
      (Constants.MAX_HEIGHT - Constants.YR * 250 - Constants.YR * 112) / 11,
  ...
  playCell: {
    width: Constants.MAX_WIDTH / 11,
    height:
      (Constants.MAX_HEIGHT - Constants.YR * 250 - Constants.YR * 112) / 13,
    alignItems: 'center',
    borderWidth: 5,
    borderColor: 'blue',
  },
